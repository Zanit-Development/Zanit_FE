import { CocktailProps } from "../interface/interfaceCocktail";

interface cocktailPropsWithBarUid extends CocktailProps {
  barUid: number;
}

export const searchCocktailItems: cocktailPropsWithBarUid[] = [
  {
    barUid: 0,
