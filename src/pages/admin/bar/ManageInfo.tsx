      ...
      <StyledForm onSubmit={handleSubmit} ref={formRef}>
        ...
        <section>
          ...
          <StyledSectionBarInfo>
            ...
            <SelectBox name="barLocation" styletype="secondary" data={["#중랑구 ", "#서대문구 ", "#중구 "]} placeholder={"선택"} nulltext={"선택"}></SelectBox>
            <Input {...BAR_INFO.LOCATION_DETAIL} />
          </StyledSectionBarInfo>
          {/** 3. 바 분위기(barMood) */}
          <StyledSectionBarInfo>
            <StyledH3>분위기</StyledH3>
            <SelectBox name="barMood" styletype="secondary" data={["#캐주얼한", "#고급스러운", "#신나는"]} placeholder={"선택"} nulltext={"선택"}></SelectBox>
          </StyledSectionBarInfo>
          {/** 4, 5. 커버차지(activeCoverCharge, coverCharge) */}
          <StyledSectionBarInfo>
            <StyledH3>커버차지</StyledH3>
            <SelectBox name="activatedCoverCharge" styletype="secondary" data={["있음", "없음"]} placeholder={"선택"} nulltext={"선택"}></SelectBox>
            <Input {...BAR_INFO.COVER_CHARGE} />
          </StyledSectionBarInfo>
          {/** 6, 7. 커버차지 할인(activeDicount, discount) */}
          <StyledSectionBarInfo>
            <StyledH3>커버차지</StyledH3>
            <SelectBox name="activatedDiscount" styletype="secondary" data={["있음", "없음"]} placeholder={"선택"} nulltext={"선택"}></SelectBox>
